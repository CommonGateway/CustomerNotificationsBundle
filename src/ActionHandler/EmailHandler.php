    ...
    public function getConfiguration(): array
    {
        return [
            ...
            'properties' => [
                ...
                'bcc'        => [
                    'type'        => 'string',
                    'description' => 'Blind carbon copy, people that should receive a copy without other recipients knowing.',
                    'example'     => 'b.brother@conduction.nl',
                    'nullable'    => true,
                ],
                'replyTo'    => [
                    'type'        => 'string',
                    'description' => 'The address the receiver should reply to, only provide this if it differs from the sender\'s address.',
